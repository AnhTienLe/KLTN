...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 15, 2023 lúc 01:40 PM
...
('qq', 'qưe', 'qq', 'qq', 'qq', 'HDTNDN', 7, 'Chưa duyệt', 3);
...
CREATE TABLE `detai_hoidong` (
  ...
  `Hd_thuky` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `Hd_uyvien` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `Hd_ngaypb` date NOT NULL,
  `Hd_gioppb` time NOT NULL,
  `Hd_phongpb` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `Tbm_id` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(6, 'HD1', 'DT1', 9, 'Phạm Thị Nữ', 'Trần Đông', '2023-04-20', '00:12:19', 'B2.11', 1),
(7, 'HD2', 'DT2', 3, 'Lý Thị Đô', 'Lý Tịnh', '2023-04-28', '10:40:12', 'V2.11', 1),
...
--
ALTER TABLE `detai_hoidong`
  MODIFY `DetaiHoidong_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `giangvien`
  MODIFY `Gv_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
